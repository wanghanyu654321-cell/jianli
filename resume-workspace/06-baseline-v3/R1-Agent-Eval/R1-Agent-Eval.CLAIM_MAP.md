...
| V3-S03 | Summary sentence 3 | FCT-18 | DER-001:221-230 | FULLY_GROUNDED | 京东搜索、商品属性与排名优化均有事实定位。 |
...
| V3-W04 | 人瑞 bullet 4 | FCT-05 | DER-001:58-62 | FULLY_GROUNDED | 一致性结果保留“部分任务/复杂任务”限定。 |
| V3-W05 | 人瑞 bullet 5 | FCT-03,FCT-05 | DER-001:39-50,58-62 | FULLY_GROUNDED | SOP、培训、答疑、规则统一和复核聚类表达。 |
| V3-W06 | 人瑞 bullet 6 | FCT-06 | DER-001:63-71 | FULLY_GROUNDED | 指标观察写为参与和汇总，没有扩写完整线上权限。 |
| V3-W07 | 今宜 bullet 1 | FCT-12,FCT-13,FCT-14 | DER-001:116-179 | FULLY_GROUNDED | CTR/CVR/ROI、复盘、投流和协作边界清晰。 |
| V3-W08 | 今宜 bullet 2 | FCT-15 | DER-001:180-200 | FULLY_GROUNDED | KOC 分层、合作 SOP 和 10 万+ 销售额来自同一 Claim。 |
| V3-W09 | 朗臻 bullet 1 | FCT-18 | DER-001:221-230 | FULLY_GROUNDED | 仅保留搜索意图、关键词、商品属性和排名证据。 |
| V3-W10 | 朗臻 bullet 2 | FCT-19,FCT-20 | DER-001:231-279 | FULLY_GROUNDED | GMV 数字写明为核心单 SKU 日 GMV，并保留约 15 天口径。 |
...
| Renrui work experience | FULLY_GROUNDED | 六条 bullet 各自有 FCT 映射，数字与限定词完整。 |
