# R5｜Agent Solution / Prompt Engineering / Agent Application
...
- **Context Management：** 针对当前任务补充真正影响判断的业务 / 行业 Context，同时控制信息范围，避免额外 Context 扩大错误判断空间。 
...
- **信息表达：** 根据产品定位优化信息表达，并结合短视频 / 直播反馈持续调整用户可感知的信息结构。 
- **数据反馈：** 本人承担投流工作，结合 **CTR、CVR、ROI**判断不同内容、流量和承接方案的效果，并通过对比验证进一步缩小问题。 
- **0→1 结果：** 同一新盘账号月 GMV 从早期约 **7 万**提升至**接手首月约 43 万**；协同约 **6 人直播团队**完成策略、内容、投流和复盘。 
