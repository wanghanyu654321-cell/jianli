# R6｜MaaS / AI Solution / AI Pre-sales / Solution Consultant
...
- **达人冷启动 BD：** 新链接缺少历史销量、权重和成熟素材时，直接筛选达人并通过微信 / 电话推进 1 对 1 合作，以产品与内容匹配、历史销售和合作意愿判断优先级，形成首批合作。 
- **商业 Trade-off：** 冷启动阶段不追求达人渠道短期利润最大化，在退款、货损等基本成本风险可覆盖的前提下，可以主动让渡部分利润换取首批销量、商品权重和起盘速度。 
- **合作结果：** 达人合作 **单月销售额合计 10 万元+**；同一新盘账号月 GMV 从早期约 **7 万**提升至**接手首月约 43 万**。 
- **跨团队推进：** 协同约 **6 人直播团队**推进策略、排期、内容、主播、投流和复盘，在业务目标、执行条件和数据结果之间持续协调。 
...
- **活动与资源谈判：** 参与直接费用型、货值型活动的投入规模和合作条件讨论，并结合库存压力通过平台活动 / 资源置换推进消化。 
