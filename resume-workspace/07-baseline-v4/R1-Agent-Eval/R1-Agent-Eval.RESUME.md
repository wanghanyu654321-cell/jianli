...
- **进度与上下游协作：** 任务执行期间持续向上级同步当前阶段、进度、已发现问题和待确认事项，使上级能够及时掌握执行状态，并在规则或业务存在歧义时较早完成确认，减少后期批量返工。
...
- **经营结果与团队协作：** 协同约 **6 人直播团队**推进策略、目标拆解、排期、培训协同、跟播、内容、投流和复盘；同一新盘账号月 GMV 从早期约 **7 万**提升至后续首月约 **43 万**。
