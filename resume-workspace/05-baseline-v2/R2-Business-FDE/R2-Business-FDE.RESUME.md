...
Business FDE / AI Delivery

## Professional Summary

具备电商经营、Data Agent 评测和 Agent 应用实践的业务型 AI 交付候选人。能够从业务问题和用户意图出发拆解需求，建立评测标准、任务流程、质量反馈和验收口径；在企业客服 Agent 项目中进一步实践架构边界、工具授权、安全、证据治理与测试验收。曾负责跨渠道电商项目的经营目标、团队协同和结果跟踪，能够在业务、运营和技术协作之间推进落地。
...
- 将业务策略转成评测标准、任务拆分、QA 质检、Badcase 归因、争议裁定和数据汇总，并持续对接正式员工与产品侧。
- 负责培训、答疑、任务分配、进度跟踪、抽检和质量复核，维护 10+ SOP/规则/执行文档并统一下游执行标准。
- 在 10+ 人团队中参与每周约 5,000–10,000 条任务，个人日处理约 100–120 条，部分任务一致性约 80%→95%。
- 结合部分 DAU、点击、转化和灰度水位参与版本效果观察与问题汇总。
...
- 依据 CTR/CVR/ROI 调整素材、投放和直播执行节奏，并以达人筛选、KOC 分层和触达 SOP 跟踪合作销售额 10 万+。
...
Codex · Qoder · Business Requirement Translation · Project Planning · Quality Governance · E-commerce Operations
