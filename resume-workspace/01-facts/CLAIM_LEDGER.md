...
- `derived_from_source_epoch`: `FCT-EPOCH-20260916-6D82DB08`
...
- `CLAIM_MAPPING_INTEGRITY`: `CURRENT_FOR_FCT_MASTER`; existing Role Resume artifacts require revalidation before being considered current against this epoch.
...
|---|---|---|---|---|
| FCT-01 | 当前求职方向可围绕 FDE/AI 应用交付、Agent Eval、MaaS/AI Solution、AI 电商和 AI 产品运营做不同强调 | FCTM-XR-01~03 | FACT_DOCUMENTED | 仅作为求职方向与能力解释，不代表每个方向都有正式职位经历。 |
...
| FCT-05 | 部分任务一致性约 80%→95%，复杂任务约 60%→85%，沉淀 10+ SOP/规则/执行文档 | FCTM-RR-03 | FACT_DOCUMENTED | “部分任务”限定词必须保留；一致性不写成模型准确率。 |
| FCT-06 | 接触 DAU、CTR、转化相关指标、灰度流量、业务水位，并按小时/日等时间维度观察版本和异常变化 | FCTM-RR-16 | FACT_DOCUMENTED | 不写独立 A/B Owner、完整线上权限或独立策略；eCTR/pCTR/eCVR/pCVR/UVCTR/Lift 暂未确认。 |
...
| FCT-09 | 杭州今宜负责抖音项目代运营/项目运营/BD，2024.11–2025.07，覆盖项目经营、直播、内容、投流、店铺数据、达人 BD 等 | FCTM-TL-02, FCTM-JY-01~24 | FACT_DOCUMENTED | 不拆虚构雇佣主体。 |
...
| FCT-16 | 浙江朗臻任京东电商运营→宠物项目管理，2022.03–2024.07 | FCTM-TL-02, FCTM-LZ-01~21 | FACT_DOCUMENTED | 不写返岗。 |
...
| FCT-20 | 使用实时经营数据、京东快车、京准通、天猫引力魔方等经营与推广工具 | FCTM-LZ-18 | FACT_DOCUMENTED | 不把不同平台玩法写成同一机制。 |
...
| FCT-24 | 企业客服 Agent / Support Agent 项目定位为 Proof App，当前证据定位为 `wanghanyu654321-cell/-agent` / `job-ready/integration-v1` | FCTM-AG-00~05 | DOCUMENTED_ONLY | 当前仍 `REPO_NOT_VERIFIED`。 |
| FCT-25 | 项目材料描述 Node.js/FastAPI/PostgreSQL16/pgvector/React/Docker Compose/Nginx/Pi Runtime 和权限边界 | FCTM-AG-02 | DOCUMENTED_ONLY | 不据此宣称生产部署。 |
...
| FCT-27 | 项目材料记录 40 Frozen Cases、Safety 30/30、Robustness 100/100、Holdout 60/60、Governed Knowledge 46/46、Public Top1 96%、Recall@3 100%、Routed Outcome 100% | FCTM-AG-04 | DOCUMENTED_ONLY | 测试集结果，不是生产流量；Holdout 60/60 不等于 60 个独立样本。 |
...
- `DOCUMENTED_ONLY`：事实母版有描述，但缺对应仓库/生产/客户原始证据；不能升级成已核验实现或生产结果。
